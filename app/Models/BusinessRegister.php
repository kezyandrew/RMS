...
class BusinessRegister extends Model
{
    ...
    protected $fillable = ['slack', 'store_id', 'user_id', 'billing_counter_id', 'current_register', 'opening_date', 'closing_date', 'opening_amount', 'closing_amount', 'credit_card_slips', 'cheques', 'created_by', 'updated_by', 'created_at', 'updated_at'];
