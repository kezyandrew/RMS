<?php 
    ...
    */
    ...
    if (isset($_POST['purchase_code']) && $_POST['purchase_code'] != '' ) {
		...
		$activation_output = array();
		$activation_output['status_code'] = 200;
		$activation_output['status'] = 'valid';
		$activation_output['msg'] = 'License valid //nulled';
		$activation_output['data']['activation_code'] = '*************';
