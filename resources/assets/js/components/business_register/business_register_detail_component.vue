        ...
        <div class="col-md-12">
            ...
            <div class="d-flex flex-wrap mb-4">
                ...
                <div class="ml-auto">
                    ...
                    <button type="submit" class="btn btn-danger" v-if="delete_register_access == true && business_register.closing_date != null" v-on:click="delete_register()" v-bind:disabled="delete_processing == true"> <i class='fa fa-circle-notch fa-spin'  v-if="delete_processing == true"></i> Delete Register</button>

                    <a class="btn btn-outline-primary" v-bind:href="print_register_report_link" target="_blank">{{ $t("Print") }}</a>
                </div>
