            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="form-row mb-2">
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" name="opening_amount" v-model="opening_amount" v-validate="'decimal|min_value:0'" class="form-control form-control-custom" :placeholder="$t('Please enter Cash in Hand')"  autocomplete="off">
                        <span v-bind:class="{ 'error' : errors.has('opening_amount') }">{{ errors.first('opening_amount') }}</span> 
                    </div>
                </div>
                </div>
                <div v-else>
                    <p>All billing counters are occupied or not available!</p>
                </div>
