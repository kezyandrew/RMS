                        ...
                        <div class="form-row mb-2">
                            <div class="form-group col-md-6">
                                <div class="custom-control custom-switch">
                                    ...
                                    <small class="form-text text-muted" v-show="is_taxcode_inclusive == false">If this option is enabled, product sale price and purchase price will be replaced with ingredient cost.</small>
                                    <small class="form-text text-muted" v-show="is_taxcode_inclusive == true"><i class="fas fa-info-circle text-warning"></i> Option not available if the tax is INCLUSIVE</small>
                                </div>
                            </div>
                        </div>
                    </div>
